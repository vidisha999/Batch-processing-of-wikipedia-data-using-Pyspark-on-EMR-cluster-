...
S3_DATA_INPUT_PATH="s3://emr-athena-vidisha/input-data/wikiticker-2015-09-12-sampled.json"
S3_DATA_OUTPUT_PATH_FILTERED="s3://emr-athena-vidisha/output-data/filtered"
